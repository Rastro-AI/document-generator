...
export function Sidebar({ onNewDocument }: SidebarProps) {
  ...
  return (
    ...
    >
      <div className="flex flex-col flex-grow bg-white border-r border-slate-200 h-full shadow-sm">
        ...
        {collapsed && (
          <div className="px-2 py-2 border-b border-slate-200">
            <button
              ...
              className="w-12 h-8 flex items-center justify-center rounded-lg hover:bg-slate-100 transition-colors mx-auto"
              title="Expand"
            >
              <svg
                className="w-4 h-4 text-slate-400 hover:text-slate-600"
